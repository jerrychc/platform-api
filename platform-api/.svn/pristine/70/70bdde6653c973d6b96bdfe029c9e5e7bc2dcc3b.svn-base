...
public class InstanceDto extends BaseDto {
	...
	//流程实例当前节点及当前节点之前所有节点和连线的ID集合
	private List<String> currentAndPreviousNodeList = new ArrayList<String>();

	//可阅人json串
	private String accessibles ;
	//审批人json串
	...
	//流程模板修改时间用于打回判断是否重走
	private Timestamp flUpdateDate;

	//效率统计-流程打回重新发起标识
	private String returnRelaunch;
	public String getReturnRelaunch() {
		return returnRelaunch;
	}

	public void setReturnRelaunch(String returnRelaunch) {
		this.returnRelaunch = returnRelaunch;
	}
	...
	public List<String> getCurrentAndPreviousNodeList() {
		return currentAndPreviousNodeList;
	}

	public void setCurrentAndPreviousNodeList(List<String> currentAndPreviousNodeList) {
		this.currentAndPreviousNodeList = currentAndPreviousNodeList;
	}
	...
	public void setAccessibles(String accessibles) {
