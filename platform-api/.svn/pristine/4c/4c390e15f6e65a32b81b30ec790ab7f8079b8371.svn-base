 ...
 *
 */
public class GenerationSystableColumnDto extends BaseDto{
	...
	public String getgSystableId() {
		return gSystableId;
	}

	public void setgSystableId(String gSystableId) {
		this.gSystableId = gSystableId;
	}
