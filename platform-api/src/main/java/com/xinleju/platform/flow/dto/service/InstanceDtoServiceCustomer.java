...
public interface InstanceDtoServiceCustomer extends BaseDtoServiceCustomer{
	...
	void scanExceptionFlow(String userInfo,String params);
	 ...
	 * @return
	 */
	public String saveModifyInstance(String userInfo,String params);
	...
	/**
	  * @Description:取消传阅 
	  * @author:zhangfangzhi
	  * @date 2018年2月3日 上午10:18:38
	  * @version V1.0
	 */
	public String cancelPassAndRead(String userInfo, String id);
	public String getUserPostNew(String userInfo, String id);
}
