 ...
 */
@Controller
@RequestMapping("/oa/servey/serveyCreate")
public class ServeyCreateController {

	private static Logger log = Logger.getLogger(ServeyCreateController.class);
	...
	public @ResponseBody MessageResult get(@PathVariable("id")  String id){
		...
		try {
			String dubboResultInfo=serveyDtoServiceCustomer.getObjectById(getUserInfoJson(), "{\"id\":\""+id+"\"}");
			DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				ServeyDto serveyDto=JacksonUtils.fromJson(resultInfo, ServeyDto.class);
				result.setResult(serveyDto);
	...
	public @ResponseBody MessageResult page(@RequestBody Map<String,Object> map){
		...
		try {
		    String dubboResultInfo=serveyDtoServiceCustomer.getPage(getUserInfoJson(), paramaterJson);
		    DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
    ...
    public
    @ResponseBody
    MessageResult queryServeyQuestionList(@RequestBody Map<String, Object> map) {
        MessageResult result = new MessageResult();
        String paramaterJson = JacksonUtils.toJson(map);
        try {
	...
	public @ResponseBody MessageResult queryList(@RequestBody Map<String,Object> map){
		...
		String paramaterJson = JacksonUtils.toJson(map);
		try {
			String dubboResultInfo=serveyDtoServiceCustomer.queryList(getUserInfoJson(), paramaterJson);
		    DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
		    if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				List<ServeyDto> list=JacksonUtils.fromJson(resultInfo, ArrayList.class,ServeyDto.class);
				result.setResult(list);
				result.setSuccess(MessageInfo.GETSUCCESS.isResult());
				result.setMsg(MessageInfo.GETSUCCESS.getMsg());
		    }else{
	...
	public @ResponseBody MessageResult save(@RequestBody ServeyDto t){
		MessageResult result=new MessageResult();
		try {
			String saveJson= JacksonUtils.toJson(t);
			String dubboResultInfo=serveyDtoServiceCustomer.save(getUserInfoJson(), saveJson);
		    DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
		    if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				ServeyDto serveyDto=JacksonUtils.fromJson(resultInfo, ServeyDto.class);
	...
	public @ResponseBody MessageResult createServey(@RequestBody Map<String,Object> map){
		...
		try {
			String paramaterJson = JacksonUtils.toJson(map);
			String dubboResultInfo=serveyDtoServiceCustomer.save(getUserInfoJson(), paramaterJson);
		    DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
		    if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				ServeyDto serveyDto=JacksonUtils.fromJson(resultInfo, ServeyDto.class);
	...
	public @ResponseBody MessageResult delete(@PathVariable("id")  String id){
		MessageResult result=new MessageResult();
		try {
			String dubboResultInfo=serveyDtoServiceCustomer.deleteObjectById(getUserInfoJson(), "{\"id\":\""+id+"\"}");
			DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				ServeyDto serveyDto=JacksonUtils.fromJson(resultInfo, ServeyDto.class);
	...
	public @ResponseBody MessageResult deleteBatch(@PathVariable("ids")  String ids){
		MessageResult result=new MessageResult();
		try {
			String dubboResultInfo=serveyDtoServiceCustomer.deleteAllObjectByIds(getUserInfoJson(), "{\"id\":\""+ids+"\"}");
			DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				ServeyDto serveyDto=JacksonUtils.fromJson(resultInfo, ServeyDto.class);
	...
	public @ResponseBody MessageResult update(@PathVariable("id")  String id,   @RequestBody Map<String,Object> map){
		...
		try {
			...
			if(dubboServiceResultInfo.isSucess()){
				 ...
				 String updateDubboResultInfo=serveyDtoServiceCustomer.update(getUserInfoJson(), updateJson);
			...
			try{
			 e.printStackTrace();
			 ObjectMapper mapper = new ObjectMapper();
			 String  paramJson = mapper.writeValueAsString(serveyDto);
	...
	public @ResponseBody MessageResult deletePseudo(@PathVariable("id")  String id){
		MessageResult result=new MessageResult();
		try {
			String dubboResultInfo=serveyDtoServiceCustomer.deletePseudoObjectById(getUserInfoJson(), "{\"id\":\""+id+"\"}");
			DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				ServeyDto serveyDto=JacksonUtils.fromJson(resultInfo, ServeyDto.class);
	...
	public @ResponseBody MessageResult deletePseudoBatch(@PathVariable("ids")  String ids){
		MessageResult result=new MessageResult();
		try {
			String dubboResultInfo=serveyDtoServiceCustomer.deletePseudoAllObjectByIds(getUserInfoJson(), "{\"id\":\""+ids+"\"}");
			DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				ServeyDto serveyDto=JacksonUtils.fromJson(resultInfo, ServeyDto.class);
