package com.xinleju.cloud.oa.favorite.controller;
...
import com.xinleju.cloud.oa.favorite.dto.FavoriteDto;
...
public class FavoriteController {
    ...
    MessageResult get(@PathVariable("id") String id) {
        ...
        try {
            ...
            String dubboResultInfo = favoriteDtoServiceCustomer.getObjectById(userInfo, "{\"id\":\"" + id + "\"}");
    ...
    public
    @ResponseBody
    MessageResult save(@RequestBody FavoriteDto t) {
        MessageResult result = new MessageResult();
        try {
            SecurityUserBeanInfo securityUserBeanInfo = LoginUtils.getSecurityUserBeanInfo();
            String userInfo = JacksonUtils.toJson(securityUserBeanInfo);
    ...
    MessageResult delete(@PathVariable("id") String id) {
        ...
        try {
            ...
            String dubboResultInfo = favoriteDtoServiceCustomer.deleteObjectById(userInfo, "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                FavoriteDto favoriteDto = JacksonUtils.fromJson(resultInfo, FavoriteDto.class);
    ...
    MessageResult deleteBatch(@PathVariable("ids") String ids) {
        ...
        try {
            ...
            String dubboResultInfo = favoriteDtoServiceCustomer.deleteAllObjectByIds(userInfo, "{\"id\":\"" + ids + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                FavoriteDto favoriteDto = JacksonUtils.fromJson(resultInfo, FavoriteDto.class);
    ...
    MessageResult update(@PathVariable("id") String id, @RequestBody Map<String, Object> map) {
        ...
        try {
            ...
            if (dubboServiceResultInfo.isSucess()) {
                ...
                String updateDubboResultInfo = favoriteDtoServiceCustomer.update(userInfo, updateJson);
            ...
            try {
                e.printStackTrace();
                ObjectMapper mapper = new ObjectMapper();
                String paramJson = mapper.writeValueAsString(favoriteDto);
    ...
    MessageResult deletePseudo(@PathVariable("id") String id) {
        ...
        try {
            ...
            String dubboResultInfo = favoriteDtoServiceCustomer.deletePseudoObjectById(userInfo, "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                FavoriteDto favoriteDto = JacksonUtils.fromJson(resultInfo, FavoriteDto.class);
    ...
    MessageResult deletePseudoBatch(@PathVariable("ids") String ids) {
        ...
        try {
            ...
            String dubboResultInfo = favoriteDtoServiceCustomer.deletePseudoAllObjectByIds(userInfo, "{\"id\":\"" + ids + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                FavoriteDto favoriteDto = JacksonUtils.fromJson(resultInfo, FavoriteDto.class);
