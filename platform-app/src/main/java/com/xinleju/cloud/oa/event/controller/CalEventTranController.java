...
import com.xinleju.cloud.oa.event.dto.CalEventTranDto;
import com.xinleju.cloud.oa.event.dto.service.CalEventTranDtoServiceCustomer;
 ...
 */
@Controller
@RequestMapping("/oa/event/calEventTran")
public class CalEventTranController {

	private static Logger log = Logger.getLogger(CalEventTranController.class);

	@Autowired
	private CalEventTranDtoServiceCustomer calEventTranDtoServiceCustomer;
	/**
	 * 根据Id获取业务对象
	 *
	 * @param id  业务对象主键
	...
	public @ResponseBody MessageResult save(@RequestBody CalEventTranDto t){
		MessageResult result=new MessageResult();
		try {
