 ...
 */
@Controller
@RequestMapping("/oa/servey/serveyResponse")
public class ServeyResponseController {

    private static Logger log = Logger.getLogger(ServeyResponseController.class);

    @Autowired
    private ServeyResponseDtoServiceCustomer serveyResponseDtoServiceCustomer;
    ...
    MessageResult get(@PathVariable("id") String id) {
        ...
        try {
            String dubboResultInfo = serveyResponseDtoServiceCustomer.getObjectById(getUserInfoJson(), "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyResponseDto serveyResponseDto = JacksonUtils.fromJson(resultInfo, ServeyResponseDto.class);
                result.setResult(serveyResponseDto);
    ...
    MessageResult page(@RequestBody Map<String, Object> map) {
        ...
        try {
            ...
            String dubboResultInfo = serveyResponseDtoServiceCustomer.getPage(getUserInfoJson(), paramaterJson);
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
    ...
    MessageResult queryList(@RequestBody Map<String, Object> map) {
        ...
        String paramaterJson = JacksonUtils.toJson(map);
        try {
            String dubboResultInfo = serveyResponseDtoServiceCustomer.queryList(getUserInfoJson(), paramaterJson);
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
    ...
    public
    @ResponseBody
    MessageResult save(@RequestBody ServeyResponseDto t) {
        MessageResult result = new MessageResult();
        try {
        	SecurityUserBeanInfo securityUserBeanInfo = LoginUtils.getSecurityUserBeanInfo();
            ...
            String dubboResultInfo = serveyResponseDtoServiceCustomer.save(getUserInfoJson(), saveJson);
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyResponseDto serveyResponseDto = JacksonUtils.fromJson(resultInfo, ServeyResponseDto.class);
    ...
    MessageResult delete(@PathVariable("id") String id) {
        MessageResult result = new MessageResult();
        try {
            String dubboResultInfo = serveyResponseDtoServiceCustomer.deleteObjectById(getUserInfoJson(), "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyResponseDto serveyResponseDto = JacksonUtils.fromJson(resultInfo, ServeyResponseDto.class);
    ...
    MessageResult deleteBatch(@PathVariable("ids") String ids) {
        MessageResult result = new MessageResult();
        try {
            String dubboResultInfo = serveyResponseDtoServiceCustomer.deleteAllObjectByIds(getUserInfoJson(), "{\"id\":\"" + ids + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyResponseDto serveyResponseDto = JacksonUtils.fromJson(resultInfo, ServeyResponseDto.class);
    ...
    MessageResult update(@PathVariable("id") String id, @RequestBody Map<String, Object> map) {
        MessageResult result = new MessageResult();
        ServeyResponseDto serveyResponseDto = null;
        try {
            String dubboResultInfo = serveyResponseDtoServiceCustomer.getObjectById(getUserInfoJson(), "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                ...
                String updateDubboResultInfo = serveyResponseDtoServiceCustomer.update(getUserInfoJson(), updateJson);
            ...
            try {
                e.printStackTrace();
                ObjectMapper mapper = new ObjectMapper();
                String paramJson = mapper.writeValueAsString(serveyResponseDto);
    ...
    MessageResult deletePseudo(@PathVariable("id") String id) {
        MessageResult result = new MessageResult();
        try {
            String dubboResultInfo = serveyResponseDtoServiceCustomer.deletePseudoObjectById(getUserInfoJson(), "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyResponseDto serveyResponseDto = JacksonUtils.fromJson(resultInfo, ServeyResponseDto.class);
    ...
    MessageResult deletePseudoBatch(@PathVariable("ids") String ids) {
        MessageResult result = new MessageResult();
        try {
            String dubboResultInfo = serveyResponseDtoServiceCustomer.deletePseudoAllObjectByIds(getUserInfoJson(), "{\"id\":\"" + ids + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyResponseDto serveyResponseDto = JacksonUtils.fromJson(resultInfo, ServeyResponseDto.class);
	...
	public
	@ResponseBody
	MessageResult saveTemporary(@RequestBody ServeyResponseDto t) {
		MessageResult result = new MessageResult();
		try {
			SecurityUserBeanInfo userBeanInfo = LoginUtils.getSecurityUserBeanInfo();
			t.setUserId(userBeanInfo.getSecurityUserDto().getId());
			String saveJson = JacksonUtils.toJson(t);
			String dubboResultInfo = serveyResponseDtoServiceCustomer.saveTemporary(getUserInfoJson(), saveJson);
			DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if (dubboServiceResultInfo.isSucess()) {
				String resultInfo = dubboServiceResultInfo.getResult();
				ServeyResponseDto serveyResponseDto = JacksonUtils.fromJson(resultInfo, ServeyResponseDto.class);
    ...
    MessageResult queryListByParameter(@RequestBody Map<String, Object> map) {
        ...
        String paramaterJson = JacksonUtils.toJson(map);
        try {
            String dubboResultInfo = serveyResponseDtoServiceCustomer.queryListByParameter(getUserInfoJson(), paramaterJson);
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                List<ServeyResponseDto> list = JacksonUtils.fromJson(resultInfo, ArrayList.class, ServeyResponseDto.class);
