 ...
 */
@Controller
@RequestMapping("/oa/servey/serveyQuestion")
public class ServeyQuestionController {

    private static Logger log = Logger.getLogger(ServeyQuestionController.class);
    ...
    MessageResult get(@PathVariable("id") String id) {
        ...
        try {
            String dubboResultInfo = serveyQuestionDtoServiceCustomer.getObjectById(getUserInfoJson(), "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyQuestionDto serveyQuestionDto = JacksonUtils.fromJson(resultInfo, ServeyQuestionDto.class);
                result.setResult(serveyQuestionDto);
    ...
    MessageResult page(@RequestBody Map<String, Object> map) {
        ...
        try {
            String dubboResultInfo = serveyQuestionDtoServiceCustomer.getPage(getUserInfoJson(), paramaterJson);
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
...
//                List<ServeyQuestionDto> list = JacksonUtils.fromJson(resultInfo, ArrayList.class, ServeyQuestionDto.class);
    ...
    public
    @ResponseBody
    MessageResult save(@RequestBody ServeyQuestionDto t) {
        MessageResult result = new MessageResult();
        try {
            String saveJson = JacksonUtils.toJson(t);
            String dubboResultInfo = serveyQuestionDtoServiceCustomer.save(getUserInfoJson(), saveJson);
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyQuestionDto serveyQuestionDto = JacksonUtils.fromJson(resultInfo, ServeyQuestionDto.class);
    ...
    MessageResult delete(@PathVariable("id") String id) {
        MessageResult result = new MessageResult();
        try {
            String dubboResultInfo = serveyQuestionDtoServiceCustomer.deleteObjectById(getUserInfoJson(), "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyQuestionDto serveyQuestionDto = JacksonUtils.fromJson(resultInfo, ServeyQuestionDto.class);
    ...
    MessageResult deleteBatch(@PathVariable("ids") String ids) {
        MessageResult result = new MessageResult();
        try {
            String dubboResultInfo = serveyQuestionDtoServiceCustomer.deleteAllObjectByIds(getUserInfoJson(), "{\"id\":\"" + ids + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyQuestionDto serveyQuestionDto = JacksonUtils.fromJson(resultInfo, ServeyQuestionDto.class);
    ...
    MessageResult update(@PathVariable("id") String id, @RequestBody Map<String, Object> map) {
        MessageResult result = new MessageResult();
        ServeyQuestionDto serveyQuestionDto = null;
        try {
            String dubboResultInfo = serveyQuestionDtoServiceCustomer.getObjectById(getUserInfoJson(), "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                ...
                String updateDubboResultInfo = serveyQuestionDtoServiceCustomer.update(getUserInfoJson(), updateJson);
            ...
            try {
                e.printStackTrace();
                ObjectMapper mapper = new ObjectMapper();
                String paramJson = mapper.writeValueAsString(serveyQuestionDto);
    ...
    MessageResult deletePseudo(@PathVariable("id") String id) {
        MessageResult result = new MessageResult();
        try {
            String dubboResultInfo = serveyQuestionDtoServiceCustomer.deletePseudoObjectById(getUserInfoJson(), "{\"id\":\"" + id + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyQuestionDto serveyQuestionDto = JacksonUtils.fromJson(resultInfo, ServeyQuestionDto.class);
    ...
    MessageResult deletePseudoBatch(@PathVariable("ids") String ids) {
        MessageResult result = new MessageResult();
        try {
            String dubboResultInfo = serveyQuestionDtoServiceCustomer.deletePseudoAllObjectByIds(getUserInfoJson(), "{\"id\":\"" + ids + "\"}");
            DubboServiceResultInfo dubboServiceResultInfo = JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
            if (dubboServiceResultInfo.isSucess()) {
                String resultInfo = dubboServiceResultInfo.getResult();
                ServeyQuestionDto serveyQuestionDto = JacksonUtils.fromJson(resultInfo, ServeyQuestionDto.class);
