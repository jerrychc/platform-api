...
public class CalendarBasicController {

	private static Logger log = Logger.getLogger(CalendarBasicController.class);
	
	@Autowired
	private CalendarBasicDtoServiceCustomer calendarBasicDtoServiceCustomer;
	/**
	 * 根据Id获取业务对象
	 * 
	 * @param id  业务对象主键
	...
	public @ResponseBody MessageResult save(@RequestBody CalendarBasicDto t){
		MessageResult result=new MessageResult();
		try {
			//当前登录用户
			SecurityUserBeanInfo userBeanInfo = LoginUtils.getSecurityUserBeanInfo();
