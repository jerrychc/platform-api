...
public class SysNoticeMsgUserConfigController {

	private static Logger log = Logger.getLogger(SysNoticeMsgUserConfigController.class);

	@Autowired
	private SysNoticeMsgUserConfigDtoServiceCustomer sysNoticeMsgUserConfigDtoServiceCustomer;
	...
	public @ResponseBody MessageResult save(@RequestBody SysNoticeMsgUserConfigDto t){
		MessageResult result=new MessageResult();
		try {
			//当前登录用户
			SecurityUserBeanInfo userBeanInfo = LoginUtils.getSecurityUserBeanInfo();
