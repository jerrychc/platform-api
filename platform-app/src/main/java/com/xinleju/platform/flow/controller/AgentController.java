...
public class AgentController {
	...
	@Autowired
	private AgentDtoServiceCustomer agentDtoServiceCustomer;
	/**
	 * 根据Id获取业务对象
	 * 
	 * @param id  业务对象主键
	...
	public @ResponseBody MessageResult queryAgentInstanceList(@RequestBody Map<String,Object> map){
		MessageResult result=new MessageResult();
		String paramaterJson = JacksonUtils.toJson(map);
		try {
			SecurityUserBeanInfo securityUserBeanInfo = LoginUtils.getSecurityUserBeanInfo();
	...
	public @ResponseBody MessageResult save(@RequestBody AgentDto t){
	 ...
	 * @return
	 */
	@RequestMapping(value="/queryAgentByUserAndTimeIntersection",method={RequestMethod.POST}, consumes="application/json")
	public @ResponseBody MessageResult queryAgentByUserAndTimeIntersection(@RequestBody AgentDto t){
		MessageResult result=new MessageResult();

		String paramaterJson = JacksonUtils.toJson(t);
		try {
			SecurityUserBeanInfo securityUserBeanInfo = LoginUtils.getSecurityUserBeanInfo();
			String userInfo = JacksonUtils.toJson(securityUserBeanInfo);

			String dubboResultInfo=agentDtoServiceCustomer.queryAgentByUserAndTimeIntersection(userInfo,t);
			DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				result.setSuccess(MessageInfo.SAVESUCCESS.isResult());
			...
			////e.printStackTrace();
			log.error("调用queryAgentByUserAndTimeIntersection方法:  【参数"+paramaterJson+"】======"+"【"+e.getMessage()+"】");
			result.setSuccess(MessageInfo.GETERROR.isResult());
			result.setMsg(MessageInfo.GETERROR.getMsg()+"【"+e.getMessage()+"】");
		}
		return result;
