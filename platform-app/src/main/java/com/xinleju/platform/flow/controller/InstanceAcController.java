...
public class InstanceAcController {

	private static Logger log = Logger.getLogger(InstanceAcController.class);
	
	@Autowired
	private InstanceAcDtoServiceCustomer instanceAcDtoServiceCustomer;
	/**
	 * 根据Id获取业务对象
	 * 
	 * @param id  业务对象主键
	...
	public @ResponseBody MessageResult page(@RequestBody Map<String,Object> map){
		...
		try {
		    ...
		    String dubboResultInfo=instanceAcDtoServiceCustomer.getPage(userInfo, paramaterJson);
		    DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
	...
	public @ResponseBody MessageResult save(@RequestBody InstanceAcDto t){
		MessageResult result=new MessageResult();
		try {
			SecurityUserBeanInfo securityUserBeanInfo = LoginUtils.getSecurityUserBeanInfo();
			String userInfo = JacksonUtils.toJson(securityUserBeanInfo);
	...
	public @ResponseBody MessageResult deletePseudo(@PathVariable("id")  String id){
		...
		try {
			...
			String dubboResultInfo=instanceAcDtoServiceCustomer.deletePseudoObjectById(userInfo, "{\"id\":\""+id+"\"}");
			DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				InstanceAcDto instanceAcDto=JacksonUtils.fromJson(resultInfo, InstanceAcDto.class);
