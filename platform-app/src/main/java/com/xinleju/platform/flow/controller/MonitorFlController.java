...
public class MonitorFlController {

	private static Logger log = Logger.getLogger(MonitorFlController.class);
	
	@Autowired
	private MonitorFlDtoServiceCustomer monitorFlDtoServiceCustomer;
	/**
	 * 根据Id获取业务对象
	 * 
	 * @param id  业务对象主键
	...
	public @ResponseBody MessageResult queryMonitorFlowList(@RequestBody Map<String,Object> map){
		MessageResult result=new MessageResult();
		String paramaterJson = JacksonUtils.toJson(map);
		try {
			SecurityUserBeanInfo userBeanInfo = LoginUtils.getSecurityUserBeanInfo();
	...
	public @ResponseBody MessageResult save(@RequestBody MonitorFlDto t){
		MessageResult result=new MessageResult();
		try {
