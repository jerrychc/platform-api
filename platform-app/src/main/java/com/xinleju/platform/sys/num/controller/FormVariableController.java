...
public class FormVariableController {
	...
	private static Logger log = Logger.getLogger(FormVariableController.class);
	...
	public @ResponseBody MessageResult save(@RequestBody FormVariableDto t){
		MessageResult result=new MessageResult();
		try {
			//获取用户对象
			SecurityUserBeanInfo user=LoginUtils.getSecurityUserBeanInfo();
	...
	public @ResponseBody MessageResult saveAllFormVariable(@RequestBody List<Map<String,Object>> t){
		MessageResult result=new MessageResult();
		try {
			//获取用户对象
			SecurityUserBeanInfo user=LoginUtils.getSecurityUserBeanInfo();
