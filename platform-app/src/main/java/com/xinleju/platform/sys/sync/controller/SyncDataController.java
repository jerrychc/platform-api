package com.xinleju.platform.sys.sync.controller;
...
import com.xinleju.platform.sys.sync.dto.SyncDataDto;
...
public class SyncDataController {
	...
	private static Logger log = Logger.getLogger(SyncDataController.class);
	
	@Autowired
	private SyncDataDtoServiceCustomer syncDataDtoServiceCustomer;
	/**
	 * 根据Id获取业务对象
	 * 
	 * @param id  业务对象主键
	...
	public @ResponseBody MessageResult page(@RequestBody Map<String,Object> map){
		...
		String userJson = JacksonUtils.toJson(userBeanInfo);
		try {
		    String dubboResultInfo=syncDataDtoServiceCustomer.getPage(userJson, paramaterJson);
		    DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
	...
	public @ResponseBody MessageResult queryList(@RequestBody Map<String,Object> map){
		...
		String userJson = JacksonUtils.toJson(userBeanInfo);
		try {
			String dubboResultInfo=syncDataDtoServiceCustomer.queryList(userJson, paramaterJson);
		    DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
		    if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				List<SyncDataDto> list=JacksonUtils.fromJson(resultInfo, ArrayList.class,SyncDataDto.class);
	...
	public @ResponseBody MessageResult save(@RequestBody SyncDataDto t){
		MessageResult result=new MessageResult();
		SecurityUserBeanInfo userBeanInfo = LoginUtils.getSecurityUserBeanInfo();
		String userJson = JacksonUtils.toJson(userBeanInfo);
		try {
	...
	public @ResponseBody MessageResult syncData(@PathVariable("id")  String id){
		MessageResult result=new MessageResult();
		SecurityUserBeanInfo userBeanInfo = LoginUtils.getSecurityUserBeanInfo();
		String userJson = JacksonUtils.toJson(userBeanInfo);
		try {
	...
	public @ResponseBody MessageResult syncDataOne(@PathVariable("id")  String id){
		MessageResult result=new MessageResult();
		SecurityUserBeanInfo userBeanInfo = LoginUtils.getSecurityUserBeanInfo();
		String userJson = JacksonUtils.toJson(userBeanInfo);
		try {
			String dubboResultInfo=syncDataDtoServiceCustomer.syncDataOne(userJson, "{\"id\":\""+id+"\"}");
			DubboServiceResultInfo dubboServiceResultInfo= JacksonUtils.fromJson(dubboResultInfo, DubboServiceResultInfo.class);
			if(dubboServiceResultInfo.isSucess()){
				String resultInfo= dubboServiceResultInfo.getResult();
				SyncDataDto syncDataDto=JacksonUtils.fromJson(resultInfo, SyncDataDto.class);
