...
import com.xinleju.platform.sys.notice.dto.SysNoticePhoneMsgHistoryDto;
...
public class SysNoticePhoneMsgHistoryController {
	...
	private static Logger log = Logger.getLogger(SysNoticePhoneMsgHistoryController.class);
	
	@Autowired
	private SysNoticePhoneMsgHistoryDtoServiceCustomer sysNoticePhoneMsgHistoryDtoServiceCustomer;
	/**
	 * 根据Id获取业务对象
	 * 
	 * @param id  业务对象主键
	...
	public @ResponseBody MessageResult save(@RequestBody SysNoticePhoneMsgHistoryDto t){
		MessageResult result=new MessageResult();
		try {
			//获取用户对象
			SecurityUserBeanInfo user=LoginUtils.getSecurityUserBeanInfo();
