...
function loadBill(){
	...
	vapplicant = $('#vapplicant').val();
	housename = $('#housename').val();
	feebillcode = $('#feebillcode').val();
	vjkrname = $('#vjkrname').val();
	nexpensemny = $('#nexpensemny').val();
//	if(!bl){
	$('#generateList').GridUnload();
		loadBillGridColmn();
//	}else{
	...
	jQuery("#generateList").jqGrid(
            {
                ...
                postData:{
                	...
                	subject:subject,billcode:billcode,vapplicant:vapplicant,housename:housename,feebillcode:feebillcode,vjkrname:vjkrname,nexpensemny:nexpensemny
                	},
                jsonReader : {
                    repeatitems: false
                },
