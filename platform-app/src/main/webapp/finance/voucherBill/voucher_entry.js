...
var fn = function(){
	$("#gbox_voucherEntryList .ui-jqgrid-bdiv table").jqGrid().setGridHeight($(window).height()-400);
	$("#gbox_voucherBillRelationList .ui-jqgrid-bdiv table").jqGrid().setGridHeight($(window).height()-200);
    $(".ui-jqgrid-bdiv table").jqGrid().setGridWidth($('.tabs').width(), true);
