...
$(function () {
            ...
            success: function (xhr, textStatus) {
                if (xhr) {
                    if (xhr.success) {
                        ...
                        var code = {name: 'code',label : 'code',hidden: true,sortable:false};
                        colModel.push(code);
            ...
            if(data){
                ...
                $.xljUtils.initJqGrid({
                    ...
                    postData: {
                        ...
                        'sortFields': JSON.stringify({'stick': 'desc','newsCustomStatus':'ASC','sortNum':'DESC','publishDate': 'desc'}),
    ...
    function deleteNEWS() {
        ...
        if (ids.length != 0) {
            ...
            if(flag){
                $.xljUtils.tip('blue', "不能删除处于非草稿状态的数据！");
                return;
            }
