...
(function(){
    ...
    selectMenuListFn.prototype = {
        ...
        loadingTemplate : function(){
            var html  = $(`<div style="position:absolute; z-index: 999999; background:transparent">
                <div>正在加载中。。。</div>
            </div>`);
            return html;
        },
        ...
        _getGender : function(id){
            var imgUrl = "";
            var my = this;
            // my._havePicDataList = my._havePicDataList ? my._havePicDataList : {};
            // my._havePicDataList[id] = my._havePicDataList[id] ? my._havePicDataList[id] : {};
            if(my._havePicDataList && my._havePicDataList[id] && my._havePicDataList[id].headPortrait ){
                imgUrl = (my._havePicDataList[id].headPortrait + "&imgType=0") || "../../../common/utils/selectMobile/person@2x.png?v=1";
            }else if(my._havePicDataList && my._havePicDataList[id] && my._havePicDataList[id].gender ){
                var gender = my._havePicDataList[id].gender;
                switch (gender){
                    case "1":  //男
                        imgUrl = "../../../common/utils/selectMobile/person1@2x.png?v=1"
                        break;
                    case "0":  //女
                        imgUrl = ""
                        break;
        ...
        _findNode : function(id,data){
            ...
            $element.each(function(){
                var $this = $(this);
                var imgUrl = my._getGender(id) || ("../../../common/utils/selectMobile/person@2x.png?v=1");
