	...
	opeLogGridObj = jQuery("#opeLogList").jqGrid(
			{
				...
				colModel : [ //jqGrid每一列的配置信息。包括名字，索引，宽度,对齐方式.....
			                 ...
			                 {name : 'note',label : '操作记录内容',width : 180,align : "center",formatter:function (cellvalue, options, rowObject) {
								 ...
								 return '<a href="javascript:void(0);" style="color:#46A7FF;" onclick="showNote(\''+rowObject.id+'\',\''+ rowObject.ifLong +'\')">'+$.xljUtils.escapeHtml(cellvalue)+'</a>';
							 }}
	             ],
	             rownumWidth:55,
	             rowNum : 20,//一页显示多少条
				...
				afterInsertRow:function (rowId,rowData) {
					$('#'+rowId+' td:last').removeAttr('title');
				},
