...
//	  console.log({id:id, name:name,code:code, type:type,mold:mold, sort:sort,children:children,iconSkin:iconSkin,parentId:parentId});
		...
		name = name.replace(/\\\'/g,"'");
		if (treeNode) {
			treeNode = ss.addNodes(treeNode, {id:id, name:name,code:code, type:type,mold:mold, sort:sort,children:children,iconSkin:iconSkin,parentId:parentId,status:status});
		} else {
			treeNode = ss.addNodes(null, {id:id, name:name,code:code, type:type,mold:mold, sort:sort,children:children,iconSkin:iconSkin,status:status});
		}
