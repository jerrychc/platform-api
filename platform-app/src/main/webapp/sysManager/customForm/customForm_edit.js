...
function innerDeal(){
	...
	$('#mobileUrl').attr("readonly","readonly");
  	...
  	$('.resource-selecter').xljSingleSelector({
		...
		saveCallback:function (selectData,ele) {
			if (selectData != null) {
				...
				$("#custForm").find("input[name='mobileUrl']").val(selectData.mobileUrl);
			}
		},
		treeSettings:{data:{
			simpleData: {
