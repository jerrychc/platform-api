        ...
        switch (oprType) {
            ...
            case 'paste':
                ...
                for (var i = 0; i < copyCells.length; i++) {
                    ...
                    cell.extra = JSON.stringify(extra);
                    ...
                    if(participant&&participant!=''){
                        ...
                        for (var j = 0; j < participant.length; j++) {
                            var obj = participant[j];
                            var newObj = {};
                            newObj.id=utils.getUUID(1);
                            newObj.acId = cell.id;
                            newObj.participantId = obj.participantId;
                            newObj.participantName = obj.participantName;
                            newObj.postId = obj.postId;
                            newObj.postName = obj.postName;
                            newObj.postStatus = '1';
                            newObj.status = '1';
                            newObj.taskStatus = '1';
                            participantArr.push(newObj);
                        }

                        cell.participant = JSON.stringify(participantArr);
                    }
                }
                break;
