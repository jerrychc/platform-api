                    ...
                    if(cell.nodeType=='task'){
                        ...
                        if(cell.participant&&cell.participant!=''){
                            ...
                            for(var i=0;i<participantArr.length;i++){
                                ...
                                if(participant.participantType=='4'){
                                    ...
                                    var postName = participant.postName;
                                    if(postName&&postName.lastIndexOf("/")<(postName.length-1)){
                                        postName += '/';
                                    }
                                    participantStr += postName + participant.participantName + ';\n';
                                }
                        ...
                        if(cell.ccPerson&&cell.ccPerson!=''){
                            ...
                            for(var i=0;i<ccPersonArr.length;i++){
                                ...
                                var postName = ccPerson.postName;
                                if(postName&&postName.lastIndexOf("/")<(postName.length-1)){
                                    postName += '/';
                                }
                                ccPersonStr += postName+ccPerson.participantName + ';\n';
                            }
                            if(ccPersonStr!=''){
                                tip += '环节抄送人：\n【' + ccPersonStr + '】\n';
                            }
