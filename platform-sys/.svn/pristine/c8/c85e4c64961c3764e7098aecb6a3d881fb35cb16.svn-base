...
public class InstanceStatDaoImpl extends BaseDaoImpl<String,InstanceStat> implements InstanceStatDao{
	...
	@Override
	public List<ApprovalStatDto> getPageSort(Map map) {
		return  getSqlSession().selectList("com.xinleju.platform.flow.entity.InstanceStat.getPageSort", map);
	}

	@Override
	public Integer getPageSortCount(Map map) {
		return  getSqlSession().selectOne("com.xinleju.platform.flow.entity.InstanceStat.getPageSortCount", map);
	}
