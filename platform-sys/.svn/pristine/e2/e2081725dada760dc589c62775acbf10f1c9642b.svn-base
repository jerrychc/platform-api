...
public class FuncPermissionDaoImpl extends BaseDaoImpl<String,FuncPermission> implements FuncPermissionDao{
	...
	@Override
	public List<Map<String, Object>> queryAuthorizationListAllUser(Map<String,Object> map) {
		
		return getSqlSession().selectList("com.xinleju.platform.sys.res.entity.FuncPermission.queryAuthorizationListAllUser",map);
	}
	...
	@Override
	public List<Map<String, Object>> queryAuthDataOrgByOperationIds(Map<String,Object> map) {
		return getSqlSession().selectList("com.xinleju.platform.sys.res.entity.FuncPermission.queryAuthDataOrgByOperationIds", map);
	}
	...
	@Override
	public List<String> selectFuncIdByRole(Map<String, Object> mapCon) throws Exception {
		return getSqlSession().selectList("com.xinleju.platform.sys.res.entity.FuncPermission.selectFuncIdByRole", mapCon);
	}
	@Override
	public Integer savebatchAuth(Map<String, Object> mapCon) throws Exception {
		return getSqlSession().insert("com.xinleju.platform.sys.res.entity.FuncPermission.savebatchAuth", mapCon);
	}
}
