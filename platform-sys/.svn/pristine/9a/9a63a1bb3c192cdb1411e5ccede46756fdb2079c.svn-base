 ...
 * generated in the com.xinleju.platform.flow.ws.msg package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.xinleju.platform.flow.ws.msg
     * 
     */
