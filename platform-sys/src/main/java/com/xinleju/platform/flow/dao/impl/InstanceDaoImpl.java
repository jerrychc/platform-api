...
public class InstanceDaoImpl extends BaseDaoImpl<String,Instance> implements InstanceDao{
	...
	@Override
	public List<Map> selectFeeFlowInstance(Map map) {
		return getSqlSession().selectList(Instance.class.getName()+".selectFeeFlowInstance",map);
	}

	@Override
	public List<Map<String, String>> monitor10(String instanceId) {
		return getSqlSession().selectList(Instance.class.getName() + ".monitor10", instanceId);
	}

	@Override
	public List<Map<String, Object>> queryOverdueAcList() {
		return getSqlSession().selectList(Instance.class.getName() + ".queryOverdueAcList");
	}

	@Override
	public List<Instance> getAllInstanceByFlId(Map<String, Object> paramMap) {
		return getSqlSession().selectList(Instance.class.getName() + ".getAllInstanceByFlId",paramMap);
	}

	@Override
	public List<Instance> getOldVersionInstanceByCurrentFlId(Map<String, Object> params) {
		return getSqlSession().selectList(Instance.class.getName() + ".getOldVersionInstanceByCurrentFlId",params);
	}
}
