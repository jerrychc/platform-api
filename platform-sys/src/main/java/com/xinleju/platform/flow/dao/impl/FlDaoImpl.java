...
public class FlDaoImpl extends BaseDaoImpl<String, Fl> implements FlDao {
	...
	public List<String> queryAllFlByCode(Map<String, Object> paramMap) {
		return getSqlSession().selectList("com.xinleju.platform.flow.entity.Fl.queryAllFlByCode", paramMap);
	}

	@Override
	public List<String> queryUpdateFlDataList(Map<String, Object> params) {
		return getSqlSession().selectList("com.xinleju.platform.flow.entity.Fl.queryUpdateFlDataList", params);
	}
}
