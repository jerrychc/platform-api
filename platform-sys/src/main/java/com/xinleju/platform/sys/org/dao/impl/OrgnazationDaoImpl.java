...
public class OrgnazationDaoImpl extends BaseDaoImpl<String,Orgnazation> implements OrgnazationDao{
	...
	@Override
	public List<Map<String,Object>> selectUserOrgAndUp(Map<String, Object> param)throws Exception{
		return getSqlSession().selectList("com.xinleju.platform.sys.org.entity.Orgnazation.selectUserOrgAndUp",param);
	}
	/**
	 * 查询数据库中code是否已存在
	...
	@Override
	public List<String> getSubUserByOrgIds(Map<String, Object> paramMap) {
		return getSqlSession().selectList("com.xinleju.platform.sys.org.entity.Orgnazation.getSubUserByOrgIds",paramMap);
	}
	@Override
